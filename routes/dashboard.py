...
# from .db import get_conn   # commented out - we don't need DB right now
...
def dashboard():
    ...
    # TEMP: All real DB queries are disabled until tables are created
    # Replace these with actual values once schema is loaded
    total_customers = 0
    total_owed_cents = 0
    customers_owing = 0
    total_stops_today = 0
    ...
    payments_today = 0
    weekly_stops = 0
    weekly_collected_cents = 0
    new_customers_week = 0
    recent_activity = []  # empty list for now

    # ────────────────────────────────────────────────────────────────
    # The real code below is commented out so the route doesn't crash.
    # Uncomment when the tables (customers, route_stops, routes, payments) exist.
    # ────────────────────────────────────────────────────────────────
    #
